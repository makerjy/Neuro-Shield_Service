...
// ─── 이름/상담사 풀 ───
const NAMES = [
  '김민수', '박영희', '정철수', '최수진', '이순자', '장동건', '한미영', '오세준',
  '윤정희', '서민호', '강은주', '조현우', '임수연', '배진호', '노미경', '류재석',
  '문소영', '안준혁', '황보라', '전기영', '송지은', '홍성민', '양미숙', '권혁진',
  '차은정', '하준성', '고은미', '남현수', '우미라', '신동호', '도영주', '피우진',
  '성혜인', '맹호진', '탁수연', '빈지현', '감승호', '봉미선', '채연수', '추경아',
  '길재혁', '편수정', '설은하', '복현호', '사유나', '금재원', '국미란', '좌민혁',
  '석보람', '어진수',
];
const COUNSELORS = ['이상담', '김상담', '박상담', '최상담'];
