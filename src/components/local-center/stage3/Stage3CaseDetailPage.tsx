...
import { derivePredictionRecommendedOps, toStage3WorkItems, workItemAutoGen } from "./stage3ActionRules";
import type {
  ExecuteActionBody,
  InterventionStatus,
  PredictionUiModel,
...
const STAGE3_SMS_TEMPLATES: SmsTemplate[] = [
  ...
  },
  {
    ...
    body: ({ centerName, centerPhone }) =>
      `[치매안심센터:${centerName}] 상담 결과에 따라 추가 검사가 도움이 될 수 있어 안내드립니다(예: 영상검사 등). 상세 진행은 상담 후 조율됩니다. 상담/예약 문의: ${centerPhone}`,
  },
  /* ── 리마인더: 시민링크 없음, 센터 안내만 ── */
  {
