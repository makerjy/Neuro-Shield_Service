...
export const CASE_RECORDS: CaseRecord[] = [
  {
    ...
    quality: "양호",
    profile: { name: "장종팔", age: 78, phone: "010-2481-9320", guardianPhone: "010-8821-1209" },
  ...
  },
  {
    ...
    quality: "주의",
    profile: { name: "박덕기", age: 73, phone: "010-3841-5520" },
    alertTags: ["연계 대기"],
  },
  {
    id: "CASE-2026-003",
    ...
    quality: "양호",
    profile: { name: "이종덕", age: 81, phone: "010-5510-2840" },
  ...
  },
  {
    ...
    quality: "양호",
    profile: { name: "최옥자", age: 66, phone: "010-7652-9213", guardianPhone: "010-4312-5591" },
    alertTags: [],
  },
  {
    id: "CASE-2026-005",
    ...
    quality: "경고",
    profile: { name: "한만복", age: 75, phone: "010-4288-7712" },
  ...
  },
  {
    ...
    quality: "양호",
    profile: { name: "윤갑순", age: 69, phone: "010-6721-2098" },
    alertTags: [],
  },
  {
    id: "CASE-2026-007",
    ...
    quality: "양호",
    profile: { name: "문복녀", age: 84, phone: "010-9191-2504" },
  ...
  },
  {
    ...
    quality: "주의",
    profile: { name: "강칠성", age: 72, phone: "010-2351-9801" },
  ...
  },
  {
    ...
    quality: "주의",
    profile: { name: "오두만", age: 79, phone: "010-4089-1302" },
    alertTags: ["SLA 임박", "재평가 필요"],
  },
  {
    id: "CASE-2026-010",
    ...
    quality: "양호",
    profile: { name: "임삼순", age: 64, phone: "010-7413-8267", guardianPhone: "010-3755-6401" },
    alertTags: ["연계 대기"],
  },
  {
    id: "CASE-2026-011",
    ...
    quality: "주의",
    profile: { name: "남복자", age: 83, phone: "010-6671-2104", guardianPhone: "010-7201-5543" },
    alertTags: ["SLA 임박"],
  },
  {
    id: "CASE-2026-012",
    ...
    quality: "양호",
    profile: { name: "조춘덕", age: 71, phone: "010-5870-3370" },
    alertTags: [],
  },
  {
    id: "CASE-2026-013",
    ...
    quality: "양호",
    profile: { name: "안달수", age: 68, phone: "010-8901-0061" },
    alertTags: [],
  },
  {
    id: "CASE-2026-014",
    ...
    quality: "양호",
    profile: { name: "양봉식", age: 70, phone: "010-3520-9912" },
    alertTags: ["재평가 필요"],
  },
  {
    id: "CASE-2026-015",
    ...
    quality: "주의",
    profile: { name: "차옥분", age: 76, phone: "010-1002-4451", guardianPhone: "010-9001-1112" },
  ...
  },
  {
    ...
    quality: "양호",
    profile: { name: "김복남", age: 67, phone: "010-****-1234" },
    alertTags: ["SLA 임박"],
  },
  {
    id: "CASE-2026-275",
  ...
  },
  {
    ...
    quality: "경고",
    profile: { name: "하덕순", age: 82, phone: "010-4721-2004" },
  ...
  },
  {
    ...
    quality: "양호",
    profile: { name: "고만수", age: 74, phone: "010-7790-6631" },
    alertTags: [],
  },
  {
    id: "CASE-2026-018",
    ...
    quality: "양호",
    profile: { name: "노영팔", age: 63, phone: "010-8101-3321", guardianPhone: "010-7750-4012" },
    alertTags: [],
  },
  {
    id: "CASE-2026-019",
    ...
    quality: "주의",
    profile: { name: "류복동", age: 77, phone: "010-3124-8823" },
  ...
  },
  {
    ...
    quality: "주의",
    profile: { name: "배옥례", age: 80, phone: "010-8823-2240" },
    alertTags: ["재평가 필요", "이탈 위험"],
  },
  {
    id: "CASE-2026-021",
    ...
    quality: "경고",
    profile: { name: "우순덕", age: 85, phone: "010-6012-5566", guardianPhone: "010-2201-8890" },
    alertTags: ["MCI 미등록", "연계 대기"],
  },
  {
    id: "CASE-2026-022",
    ...
    quality: "양호",
    profile: { name: "신갑순", age: 67, phone: "010-4781-0190" },
    alertTags: [],
  },
  {
    id: "CASE-2026-023",
    ...
    quality: "주의",
    profile: { name: "전영자", age: 72, phone: "010-2441-5567" },
    alertTags: ["이탈 위험"],
  },
  {
    id: "CASE-2026-024",
    ...
    quality: "양호",
    profile: { name: "황칠복", age: 62, phone: "010-7140-0013" },
    alertTags: [],
  },
];
